  ...
  return (
    <>
      <div className="flex flex-col gap-5">
        <div className="lg:grid grid-cols-7 gap-5 flex flex-col">
          <div className="col-span-3 flex flex-col bg-[#FEECEC] py-2 px-4 items-center justify-center gap-3 rounded-xl hover:scale-105 transition-transform duration-200 hover:drop-shadow-xl">
          ...
          <div className="col-span-3 flex flex-col py-2 px-4 items-center justify-center gap-3 rounded-xl bg-[#DEDFED] hover:scale-105 transition-transform duration-200 hover:drop-shadow-xl  ">
            ...
            <p className="text-center text-sm">Seigneur des Anneaux, Star Wars et Doctor Who</p>
          </div>
          ...
          <div className="col-span-3 flex flex-col py-2 px-4 items-center justify-center gap-3 rounded-xl bg-[#EEF3E2] hover:scale-105 transition-transform duration-200 hover:drop-shadow-xl">
